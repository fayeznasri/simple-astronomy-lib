...
public class MoonPhaseFinder {
    ...
    /**
     * Tries several close dates and returns the first answer that is after the
     * input calendar.
    ...
    /**
     * Finds a type of moon after the given calendar. Uses a recursive binary
     * search.
     * WARNING: this gives incorrect answers close to a full moon due to rounding
     * errors
    ...
    /**
     * The moon angle. For that we need the sun's position and the moon's position.
     * <br>
